...
const metadata = {
  name: 'GreenDeFi Lending Protocol',
  description: 'DeFi lending with carbon credit rewards on Hedera',
  url: typeof window !== 'undefined' ? window.location.origin : 'https://greendefi.app',
